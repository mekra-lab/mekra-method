...
- Identify the roles that existing READMEs, ADRs, and operational documents play as sources of truth and practical guides. Where separate maintenance is useful, keep guidance in existing documentation locations such as `docs/`. Internalize the context needed to understand related concepts and make judgments in OKF, while keeping responsibility for changes to the source of truth clear.
...
- What roles do code, configuration, and existing documents play as sources of truth and guides, and what context is needed in OKF to understand related concepts and make judgments?
